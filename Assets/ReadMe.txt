...
ConnectionScene – ввод имени игрока и соединения с хостом. Если в сети нет запущенного хоста, то клиент становится хостом, если есть, то подключается как клиент. 
Ввод адреса хоста, по умолчанию localhost.  Сцена offline. 
